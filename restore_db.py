...
def parse_args():
    parser = argparse.ArgumentParser(description="Generic DB Restore Script (MySQL & PostgreSQL)")
    ...
    parser.add_argument("--sql-file", required=True, help="Path to the .sql file to restore")
